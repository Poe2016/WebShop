                      	...
                      	<div class="mc">
                      		<table class="td-void order-tb">
                                	...
                                	<tr>
                                    	<th>
                                    		<div class="ordertime-cont">
												<div class="time-txt">所有待发货订单<b></b>
                            	...
                            	<%
                            		...
                            		sql = "select * from order_t where seller=\'"+mail+"\' and pay=1 and send_state=0";//查询待发货订单
                            		try{
								        ...
								        <tr class="tr-bd" id="track<%=ord_id %>" >
								            ...
								            <td rowspan="1" id="operate<%=ord_id%>">
								                <div class="operate">
													...
													<a onclick="confirm_send(<%=ord_id %>)" class="btn-again btn-again-show" target="_blank">
								                    	<b></b>
														确认发货
													</a>
													<br>
