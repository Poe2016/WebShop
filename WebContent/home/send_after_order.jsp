...
<body>
	...
	<dl class="fore3">
		...
		<dd class="fore3_1 curr " id="_MYJD_cashbox">
                      	...
                      	<div class="mc">
                      		<table class="td-void order-tb">
                                	...
                                	<tr>
                                    	<th>
                                    		<div class="ordertime-cont">
												<div class="time-txt">所有已发货订单<b></b>
                            	...
                            	<%
                            		...
                            		sql = "select * from order_t where seller=\'"+mail+"\' and pay=1 and send_state=1 and receive_state=0";//查询已发货订单
                            		try{
