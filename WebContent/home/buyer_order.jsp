				...
				<div id="main">
				 	<div id="order02" class="mod-main mod-comm lefta-box">
				 		<div class="mt">
	                       <ul class="extra-l">
	                           <li class="fore1">
	                           	<a href="buyer_order.jsp" id="ordertoPay"  class="txt curr">待付款</a>
	                           	<a href="buyer_order.jsp"><em><%=onum %></em></a>
	                           </li>
	                           <li>
	                           	<a href="payed_order.jsp" id="ordertoReceive" class="txt">待收货</a>
	                           	<a href="payed_order.jsp"><em><%=rec_num %></em></a>
	                           </li>
                      	...
                      	<div class="mc">
                      		<table class="td-void order-tb">
                                	...
                                	<tr>
                                    	<th>
                                    		<div class="ordertime-cont">
												<div class="time-txt">所有待付款订单<b></b>
                            	...
                            	<%
                            		...
                            		sql = "select * from order_t where mail=\'"+mail+"\' and pay=0";//查询待付款订单
                            		try{
                            			rs = st.executeQuery(sql);
                            			while(rs.next()){
								        ...
								        <tr class="tr-bd" id="track<%=ord_id %>" >
								            ...
								            <td rowspan="1" id="operate<%=ord_id%>">
								                <div class="operate">
								                    ...
								                    <br>
								                    <a onclick="wait_pay_right(<%=ord_id %>)" class="btn-again btn-again-show" target="_blank">
								                    	<b></b>
														立即付款
													</a>
								                    <a onclick="wait_delete(<%=ord_id %>)" class="btn-again btn-again-show" target="_blank">
								                    	<b></b>
														删除订单
													</a>
													<br>
